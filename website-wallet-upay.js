  ...
  <section class="upay-v2-reveal-scene" id="upayReveal">
    ...
    <div class="upay-v2-reveal-content">
      <div class="upay-v2-reveal-item" data-delay="0">
        ...
        <h2 class="section-title">灵活计划与周期计划<br>构成更完整的长期体验</h2>
      </div>
      <div class="upay-v2-reveal-item" data-delay="600">
        <p class="section-desc" style="margin:16px auto 0;">灵活计划随存随取，灵活奖励每日发放；周期计划参与 90 天，周期奖励更丰厚。</p>
      </div>
      <div class="upay-v2-plan-badges">
        ...
        <div class="upay-v2-plan-badge" data-delay="1600" style="border-left:3px solid #8B5CF6;">
          <div style="font-size:13px;color:#8B5CF6;margin-bottom:4px;">周期计划</div>
          <div style="font-size:20px;font-weight:800;">APY 12.5%</div>
          <div style="font-size:12px;color:var(--text-muted);margin-top:4px;">90 天周期，到期自动返还</div>
        </div>
