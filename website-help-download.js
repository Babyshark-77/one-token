...
var helpArticles = [
  ...
  {id:'plans',title:'什么是灵活计划和周期计划',tag:'计划与奖励',desc:'了解计划与奖励机制，包括灵活计划与周期计划的差异。',time:'2026-03-24',read:'3 min',body:'<h4>灵活计划</h4><p>随存随取，灵活奖励每日自动发放至 UPAY 账户。APY 约 4.5%。</p><h4>周期计划</h4><p>参与 90 天，周期奖励更丰厚，APY 约 12.5%。到期后本金与奖励一并返还。</p><h4>奖励去向</h4><p>奖励可保留在 UPAY 账户，也可转入灵活计划继续增长。</p>'},
...
var helpCategories = [
  ...
  {name:'计划与奖励',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',desc:'灵活与周期计划机制',style:'background:#D1FAE5;color:#059669;'},
...
var faqGroups = [
  ...
  {name:'计划与奖励',items:[
    {q:'灵活计划和周期计划的区别？',a:'灵活计划随存随取，奖励较温和；周期计划需锁定 90 天，奖励更丰厚。'},
    {q:'奖励如何发放？',a:'灵活奖励每日发放至 UPAY 账户；周期奖励到期后与本金一同返还。奖励可转入灵活计划。'}
  ]},
  {name:'提现与转账',items:[
